...
exports.default = (function (_Option) {
    ...
    var _options = (0, deepmerge_ts_1.deepmerge)(exports.Default, _Option);
    _options.URL = ((_a = _options.URL) === null || _a === void 0 ? void 0 : _a.endsWith("/"))
        ? _options.URL
        : "".concat(_options.URL, "/");
    return {
        name: "astro-short-urls",
        hooks: {
            "astro:build:done": function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/];
            }); }); },
        },
    };
